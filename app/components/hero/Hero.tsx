  ...
  return (
    <section className="min-h-[90vh] flex flex-col justify-center items-center px-6 pt-24 text-center">
      ...
      <motion.div 
        ...
        className="relative w-44 h-44 mb-8 rounded-full p-1 bg-gradient-to-tr from-blue-600 to-cyan-400"
      >
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold mb-4 italic">
          I&apos;m <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Your Name</span>
        </h1>
      ...
      >
        <Button size="lg" className="rounded-full h-12 px-8 text-md font-semibold hover:scale-105 transition-transform">
          <a href="/docs/resume.pdf" download className="flex items-center gap-2">
